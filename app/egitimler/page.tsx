...
const trainingGallery = [prImages[1], prImages[2], prImages[7], prImages[8]];
    ...
    <>
      ...
      <section className="section">
        <div className="container grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-4">
            <p className="section-kicker">Eğitimlerden Kareler</p>
            <h2 className="section-title">Toplulukla birlikte büyüme</h2>
            <p className="text-ink-muted">
              Etkinlikler, canlı eğitimler ve ekip buluşmalarından seçilen karelerle motivasyonu
              yükseltiyoruz.
            </p>
            <Button asChild variant="outline">
              <Link href="/iletisim">Eğitim Takvimi Sor</Link>
            </Button>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {trainingGallery.map((src, index) => (
              ...
              >
                <Image
                  src={src}
                  alt={`Songül Babacan eğitim fotoğrafı ${index + 1}`}
                  fill
